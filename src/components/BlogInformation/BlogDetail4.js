...
const BlogDetail4 = () => {
  ...
  return (
    <div>
      <AboutUs title={'METAVERSE AND MONEY'} textSize={`${isTablet? 'lg:text-[18px] md:text-[16px]': `text-[30px]`}`} />
      <div className="text-white flex flex-col text-justify mt-16 lg:ml-36 lg:mr-36 md:ml-12 md:mr-12">
        <h1 className="lg:text-[35px] md:text-[25px] font-bold mb-4">METAVERSE AND MONEY: DECRYPTING THE FUTURE</h1>
        ...
        <p className="lg:text-[18px] md:text-[16px] mt-3 mb-4 font-bold text-20">Metaverse Use Cases</p>
        ...
        <p className="lg:text-[18px] md:text-[16px] mt-3 mb-4 font-bold text-20">Money in the Metaverse</p>
        ...
        <p className="lg:text-[18px] md:text-[16px] text-end mt-3 mb-4 italic">Source: Citi GPS</p>
      </div>{' '}
    </div>
  );
};
