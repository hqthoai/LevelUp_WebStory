    ...
    <div className="card-container p-[15px] mx-4 md:mx-16">
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="w-full md:w-1/2 px-[16px]">
          <div className="bg-black px-4 md:px-[43px] py-4 md:py-[48px]">
            <div>
              <div className="nav-link relative">
                <div className="flex mb-4 md:mb-[30px] pb-4 md:pb-[36px]">
                  ...
                  <div className="absolute bottom-[-4px] left-[460px] right-[40px] h-[8px] bg-orange-700 rounded"></div>
                ...
                {activeTab === 2 && (
                  <div className="relative">
                    ...
                    <p className="text-white text-justify  text-[14px]">
                      ...
                      to resonate with the target audience, ensuring an unforgettable experience. We
                      work closely with you to bring your game concept to life. Whether it's a
                      historical epic, a fantastical journey, or a modern adventure, LEVEL UP STUDIO
                      are here to turn your vision into a captivating reality.
                    </p>
                  </div>
                )}
              </div>
