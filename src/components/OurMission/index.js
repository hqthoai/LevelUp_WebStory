      ...
      <div className="h-[100%] w-[45%] flex flex-col items-center justify-start">
        <div className="w-[70%]  space-y-6 mt-12">
          ...
          <p className="text-left text-black space-y-3 text-base font-normal">
            ...
            creators of exceptional experiences. As the first game studio in Vietnam, we've set out
            on a journey to redefine the industry's standards and expectations.
            <br />
            <br />
            Our commitment to innovation and efficiency allows us to break barriers by lowering the
            cost of making games without compromising on quality. Each of our creations embracing
            global diversity, which tells a unique story. Through our games, players can explore the
            depth of culture like never before.
            <br />
            <br />
            We're dedicated to redefine game value in the community! We understand the concerns that
            adults may have about the impact of gaming, and we're here to shatter those
