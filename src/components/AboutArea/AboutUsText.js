          ...
          <div className="flex flex-col">
            <div className="about-content justify-center text-center flex flex-row">
              <p className="text-white font-medium text-[18px]">
                Starting as a freelance team in 2019 with a group of four specialists, we worked on
                game projects for the Activision. Level Up Studio is ready to embrace every
