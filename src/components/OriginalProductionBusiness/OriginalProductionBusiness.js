      ...
      <section className="original-area pb-[70px] before-bg">
        <div className="original-container mx-[64px] px-[15px]">
          ...
          <div className="flex items-center justify-center mt-[65px]">
            ...
            >
              <div className="flex-col items-center justify-between mt-[-70px]">
                {/* title */}
                <div className="text-white font-bold text-[24px] uppercase mb-[20px]">
                  Hot deal
                </div>
                {/* content */}
                <div className="text-white text-[16px] mt-[-8px]  font-light font-pop w-[80%] text-justify ">
                ...
                {/* offer overlay */}
                <div
                  className="absolute right-0 top-[120px] -rotate-90 text-[#d98d7b] text-[40px] font-bold"
                  style={{
