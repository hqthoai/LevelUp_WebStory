...
//               // Use parentheses to wrap the JSX and return it
//               currentIndex === 1 ? (
//                 <div
//                   key={slides[i].id}
//                   className="w-[680px] h-[430px] rounded-[10px] overflow-hidden flex justify-center items-center shadow-[0 15px 50px rgba(0, 0, 0, 0.2)] mr-10 -translate-y-8 cursor-pointer"
//                 >
//                   <img
...
//                 <div
//                   key={slides[i].id}
//                   className="w-[680px] h-[430px] rounded-[10px] overflow-hidden flex justify-center items-center shadow-[0 15px 50px rgba(0, 0, 0, 0.2)] mr-10 translate-y-8"
//                 >
//                   <img
//                     src={slides[i].imageUrl}
//                     alt={slides[i].id}
...
//         <Box className="flex justify-center mt-[-32px]">
//           <IconButton>
//             <ArrowCircleLeftIcon sx={{ color: 'white', mr: 34 }} onClick={handleGoToPrevImage} />
//           </IconButton>
//           <IconButton>
        ...
        <div className="flex items-center">
          {currentImages.map((i, currentIndex) => (
            <div
              ...
              } rounded-[10px] overflow-hidden flex justify-center items-center shadow-[0 15px 50px rgba(0, 0, 0, 0.2)] mr-10 `}
            >
              <img
                src={slides[i].imageUrl}
                alt={slides[i].id}
